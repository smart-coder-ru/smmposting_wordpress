                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                <ul class="nav nav-tabs">
                                    <li class="active"><a class="btn btn-white selected" href="#tab-odnoklassniki"  data-toggle="tab"><i class="fab fa-odnoklassniki"></i> <?php echo $text_ok; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-vkontakte"	data-toggle="tab"><i class="fab fa-vk"></i> 			<?php echo $text_vk; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-telegram" 	data-toggle="tab"><i class="fab fa-telegram"></i> 		<?php echo $text_tg; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-instagram" 	data-toggle="tab"><i class="fab fa-instagram"></i> 	<?php echo $text_ig; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-facebook" 	data-toggle="tab"><i class="fab fa-facebook"></i> 	<?php echo $text_fb; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-tumblr" 	data-toggle="tab"><i class="fab fa-tumblr"></i> 		<?php echo $text_tb; ?></a></li>
                                    <li><a class="btn btn-white" href="#tab-twitter" 	data-toggle="tab"><i class="fab fa-twitter"></i> 	<?php echo $text_tw; ?></a></li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane active  col-sm-12" id="tab-odnoklassniki" >
                                        <?php if (!empty($accounts['odnoklassniki'])) { ?>
                                            <div class="form-group">
                                                ...
                                                <label><?php echo $text_account; ?> <i class="fab fa-odnoklassniki"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-telegram">
                                        <?php if (!empty($accounts['telegram'])) { ?>
                                            <div class="form-group">
                                                ...
                                                <label><?php echo $text_account; ?> <i class="fab fa-telegram"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-vkontakte">
                                        ...
                                        <?php if (!empty($accounts['vkontakte'])) { ?>
                                            <div class="form-group">
                                                ...
                                                <label><?php echo $text_account; ?> <i class="fab fa-vk"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-instagram">
                                        <?php if (!empty($accounts['instagram'])) { ?>
                                            <div class="form-group">
                                                <label><?php echo $text_account; ?> <i class="fab fa-instagram"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-facebook">
                                        <?php if (!empty($accounts['facebook'])) { ?>
                                            <div class="form-group">
                                                ...
                                                <label><?php echo $text_account; ?> <i class="fab fa-facebook"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-tumblr">
                                        <?php if (!empty($accounts['tumblr'])) { ?>
                                            <div class="form-group">
                                                <label><?php echo $text_account; ?> <i class="fab fa-tumblr"></i></label>
                                    ...
                                    <div class="tab-pane col-sm-12" id="tab-twitter">
                                        <?php if (!empty($accounts['twitter'])) { ?>
                                            <div class="form-group">
                                                <label><?php echo $text_account; ?> <i class="fab fa-twitter"></i></label>
...
<script type="text/javascript">
    ...
    */
    function getOkGroups() {
        ...
        let group_id = '<?php echo((isset($project['ok_group_id']) ? $project['ok_group_id'] : 0)); ?>';
    ...
    */
    ...
    function getVkGroups() {
        ...
        let vk_account_id = vk_selected.val(),
            ...
            group_id = '<?php echo((isset($project['vk_group_id']) ? $project['vk_group_id'] : 0)); ?>';
    ...
    */
    ...
    function getFbGroups() {
        ...
        let fb_account_id = fb_selected.val(),
            ...
            group_id = '<?php echo((isset($project['fb_group_id']) ? $project['fb_group_id'] : 0)); ?>';
