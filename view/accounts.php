                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab-posts">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#tab-odnoklassniki" data-toggle="tab"><i class="fab fa-odnoklassniki"></i> <?php echo $text_ok; ?></a></li>
                            <li><a href="#tab-vkontakte" data-toggle="tab"><i class="fab fa-vk"></i> <?php echo $text_vk; ?></a></li>
                            <li><a href="#tab-telegram" data-toggle="tab"><i class="fab fa-telegram"></i> <?php echo $text_tg; ?></a></li>
                            <li><a href="#tab-instagram" data-toggle="tab"><i class="fab fa-instagram"></i> <?php echo $text_ig; ?></a></li>
                            <li><a href="#tab-facebook" data-toggle="tab"><i class="fab fa-facebook"></i> <?php echo $text_fb; ?></a></li>
                            <li><a href="#tab-tumblr" data-toggle="tab"><i class="fab fa-tumblr"></i> <?php echo $text_tb; ?></a></li>
                            <li><a href="#tab-twitter" data-toggle="tab"><i class="fab fa-twitter"></i> <?php echo $text_tw; ?></a></li>
                        </ul>
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab-instagram">
                                ...
                                <form action="<?php echo $action_add_instagram; ?>" method="post" enctype="multipart/form-data" id="addInstagram">
                                    ...
                                    <div class="panel-footer">
                                        <a onclick="$('#addInstagram').submit();" class="btn btn-instagram waves-effect waves-light"> <span class="btn-label"><i class="fab fa-instagram"></i></span> <?php echo $button_add_instagram; ?></a>
                                    </div>
