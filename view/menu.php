...
<a href="<?php echo $contact_link; ?>"  class="btn btn-<?php echo ($route == 'contact' ? 'info' : 'primary');?> btn-md"><i class="fa fa-quote-right fa-fw"></i> <span class="hidden-xs"><?php echo $text_contacts; ?></span></a>
