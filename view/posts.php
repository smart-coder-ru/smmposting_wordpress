                    ...
                    <div class="сol-md-3 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <hr>
                                <div class="d-flex">
                                    <?php if ($post['vk']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','vk', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-vk"></i></a><?php } ?>
                                    <?php if ($post['ok']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','ok', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-odnoklassniki"></i></a><?php } ?>
                                    <?php if ($post['tg']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','tg', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-telegram"></i></a><?php } ?>
                                    <?php if ($post['fb']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','fb', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-facebook"></i></a><?php } ?>
                                    <?php if ($post['ig']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','ig', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-instagram"></i></a><?php } ?>
                                    <?php if ($post['tb']) { ?><a onclick="QuickPost('<?php echo $post["post_id"]; ?>','tb', this)" class="btn btn-success social text-white mr-1 mb-1"><i class="fab fa-tumblr"></i></a><?php } ?>
