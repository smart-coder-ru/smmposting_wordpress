    ...
    <div class="smmposting-container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="post" enctype="multipart/form-data" class="dropzone" id="dropzone" action="<?php echo $action_upload_image; ?>">

                    <input type="hidden" name="action" value="upload-attachment">
                    <input type="hidden" id="_wpnonce" name="_wpnonce" value="<?php echo wp_create_nonce('media-form'); ?>">
                    ...
                    <?php if (count($images)>0) { ?>
                        <?php foreach ($images as $key => $item) { ?>
                            <div class="dz-preview dz-processing dz-image-preview dz-complete">
                                <div class="dz-image">
                                    <img style="height: 120px;width: 120px;object-fit: cover;" alt="<?php echo $item['image']; ?>" data-dz-thumbnail="" src="<?php echo $item['image']; ?>">
                                </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        Dropzone.options.dropzone =
            ...
            removedfile: function(file)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: './index.php?route=marketing/smmposting/deleteImage',
                    data: {filename: name},
                });
            ...
            success: function(file, response)
            {
                ...
                if (resp['data']['url']) {
                    $('.hiddens').append('<input type="hidden" id="'+file.upload.uuid+'" name="images[]" value="'+resp['data']['url']+'">');
                }
            },
