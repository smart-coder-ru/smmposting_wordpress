...
register_uninstall_hook(SMMP_PLUGIN_DIR, 'SMMP_uninstallPlugin');
register_activation_hook(SMMP_PLUGIN_DIR, array($SMMP_load, 'activatePlugin'));
register_deactivation_hook(SMMP_PLUGIN_DIR, array($SMMP_load, 'deactivatePlugin'));
