<?php
class SMMP_Migrations
{
    /*
     * Version: 1.0.0
     * Date: 27.08.20
     */
    public function SMMP_migration_1() {
        global $wpdb;
    ...
    public function SMMP_migration_2() {
        global $wpdb;
        $wpdb->query("ALTER TABLE {$wpdb->prefix}smmposting_accounts CHANGE tw_oauth_verifier tw_oauth_token_secret VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci NOT NULL;");
    }
}